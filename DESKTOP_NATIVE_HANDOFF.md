...
**Still owed:** B (in-app image thumbnails, Apple-Notes attachments/HEIC, vault tag-whitelist) + C (product ideas — ask the user; Backlink Weaver is the cheap high-value one) + Phase 9. Body-editor text-entry + `applyStyling` hardening worth a look. A7 parity could extend to TagMatcher/Compiler.
