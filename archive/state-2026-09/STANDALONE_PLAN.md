...
**Visual roadmap = `roadmap/` folder** (start at `roadmap/README.md`; the app is `roadmap/ROADMAP.html`, an Artifact) — rebuilt 2026-06-19 into an **interactive "metro-tree"**: one line
